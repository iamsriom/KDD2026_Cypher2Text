...
PRUNED_SCHEMAS_DIR = REPO_ROOT / "data" / "pruned_schemas"
OUTPUT_DIR = REPO_ROOT / "data" / "results" / "cypher2text"
SIMILAR_QUERIES_DIR = REPO_ROOT / "data" / "results" / "similar_queries_cypher"
HYBRID_SIMILARITY_JSON = REPO_ROOT / "data" / "results" / "similarity" / "similarity_results.json"
# Manual dataset3 (SimilarityResultsManualDataset3 + PrunedSchemasDataset3)
PRUNED_SCHEMAS_DIR_MANUAL = PRUNED_SCHEMAS_DIR
SIMILARITY_JSON_MANUAL = HYBRID_SIMILARITY_JSON
OUTPUT_DIR_MANUAL = OUTPUT_DIR
...
def main() -> None:
    ...
    parser.add_argument(
        "--token-path",
        type=Path,
        default=Path.home() / "Huggingface_api.txt",
    ...
    parser.add_argument(
        "--openai-api-key-path",
        type=Path,
        default=Path.home() / "OpenAI_api.txt",
